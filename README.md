...
Quickstart for the local OpenAlex citation trajectory app in this folder.
...
- `hallmarks_*_works-csv-*.csv` and `Untitled-1.R`: earlier exploratory OpenAlex CSV workflow.
